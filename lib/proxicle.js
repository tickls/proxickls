        ...
        req.on('end', function() {
            ...
            try {
                ...
                mockResponses[bodyData.url] = {
                    ...
                    responseDelay: bodyData.responseDelay || 0
                };
        ...
        var server = http.createServer(function(req, res) {
            ...
            if(!handleProxyOverrideRequest(req, res)) {
                ...
                if(mockResponses[req.url] !== undefined) {
                    ...
                    proxyLog("Returning mock data [URL: " + req.url + "] [statusCode: " + mockResponse.statusCode + "] [Response body: " + JSON.stringify(mockResponse.responseBody) + "] [Delay: " + mockResponse.responseDelay + "]");
