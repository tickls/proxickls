    ...
    if(method === 'PUT' && actionUrl === 'setMockResponse') {
        ...
        req.on('end', function() {
            ...
            try {
                ...
                serverLog("Setting mock [URL: " + bodyData.url + "] [statusCode: " + statusCode + "] [Response body: " + JSON.stringify(bodyData) + "] [Delay: " + bodyData.delay + "]");
        ...
        var server = http.createServer(function(req, res) {
            ...
            if(!handleProxyOverrideRequest(req, res)) {
                ...
                if(mockResponses[req.url] !== undefined) {
                    ...
                    proxyLog("Returning mock data [URL: " + req.url + "] [statusCode: " + mockResponse.statusCode + "] [Response body: " + JSON.stringify(mockResponse.responseBody) + "] [Delay: " + (responseDelays[req.url] !== undefined ? responseDelays[req.url].delay : 0) + "]");
