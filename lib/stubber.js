...
var handleProxyAction = function (req, res, method, requestUrl) {
  ...
  if (method === 'PUT' && actionUrl === 'setMockResponse') {
    ...
    res.write(fs.readFileSync('./swagger/swagger.json', 'utf-8'));
    res.end();
  }
...
module.exports = {
  ...
  run: function () {
    ...
    serverLog("Creating proxy with target " + target.white + " (HTTPS: " + secureTarget + ")");
    ...
    serverLog("Swagger spec available at http://localhost:" + port + actionUrlBase + "swagger");
